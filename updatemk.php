				...
				<div class="col-md-10 col-md-offset-1">
					...
					<div class="fh5co-hero-wrap">
						<div class="fh5co-hero-intro">
							<h1 class="to-animate hero-animate-1">Update Data Mata Kuliah</h1>
                            <?php
	                           ...
	                           while($data = mysql_fetch_array($sqla)){
                                  ...
                                  <td>".$data['sem']."</td>
                                  <td>".$data['dosen']."</td>
		                          <td><a href='editmk.php?id_mk=".$data['id_mk']."'>Update</a></td>
                                  <td><a href='hapusmk.php?id_mk=".$data['id_mk']."'>Delete</a></td>
		                          </tr>";
	                           }
		                          echo"</table>"
	                       ?>
