				...
				<div class="col-md-10 col-md-offset-1">
					...
					<div class="fh5co-hero-wrap">
						<div class="fh5co-hero-intro">
							<h1 class="to-animate hero-animate-1">Update Data Dosen</h1>
                            <?php
	                           ...
	                           while($data = mysql_fetch_array($sqla)){
                                  ...
                                  <td>".$data['kantor']."</td>
                                  <td>".$data['mk']."</td>
		                          <td><a href='editdos.php?id_dosen=".$data['id_dosen']."'>Update</a></td>
                                  <td><a href='hapusdos.php?id_dosen=".$data['id_dosen']."'>Delete</a></td>
		                          </tr>";
	                           }
		                          echo"</table>"
	                       ?>
